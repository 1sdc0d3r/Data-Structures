...
class DoublyLinkedList:
    ...
    def delete(self, node):
        ...
        if self.head == self.tail:
            ...
            return
            # deleted_node_next = node.next
            # deleted_node_prev = node.prev

            # deleted_node_next.prev = node.prev
            # deleted_node_prev.next = node.next
            # node.prev.next = node.next
            # node.next.prev = node.prev
            # deleted_node = node

            # self.node.prev = deleted_node.next
